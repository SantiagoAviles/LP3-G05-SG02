...
public class MarcoCuadroCombinado extends JFrame {
    ...
    private static final String nombres[] = { "gatosonriendo.png", "gatomirando.png",
     "gatomolesto.png", "gatocomiendo.gif" };
    ...
    public MarcoCuadroCombinado() {
        super("Prueba de JComboBox - Joanthan Vargas y Santiago Avilés");
