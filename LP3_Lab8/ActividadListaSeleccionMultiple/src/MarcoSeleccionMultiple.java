...
public class MarcoSeleccionMultiple extends JFrame {
    private final JList<String> listaJListColores; // lista para guardar los nombres los colores
    private final JList<String> listaJListCopia; // lista en la que se van a copiar nombres de los colores
