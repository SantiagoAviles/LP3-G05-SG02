public class main {
    public static void main(String[] args) {
        ...
        Integer[] numeros = {1, 2, 3, 4, 5}; // Array de números enteros para probar
        ...
        System.out.println("Búsqueda de elemento en el array de Números: " + buscarElemento(numeros, 3));
    }


    public static <T extends Number> int buscarElemento(T[] arrayBase, T objeto){
        int posicion = -1;
        for (int i = 0; i < arrayBase.length; i++){
            if (arrayBase[i].equals(objeto)){
                posicion = i;
                break; // Terminar la búsqueda si se encuentra el elemento
            }
        }
        return posicion;
    }
